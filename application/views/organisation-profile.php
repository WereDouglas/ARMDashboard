...
<div class="row container">
 ...
 <?php
                                if ($loop->image != "") {
                                    ...
                                    echo '<img height="150px" width="150px" src="data:image/jpeg;base64,' . $loop->image . '" />';
                                } else {
                                    ?>
                                ...
                                <td> 
                                    <form  enctype="multipart/form-data" class="form-horizontal form-label-left"  action='<?= base_url(); ?>index.php/organisation/update_image'  method="post">                                       
