	                ...
	                <div class="chart-statistic-box">
	                    <div class="chart-txt">
	                        <div class="chart-txt-top">
	                            <p><span class="unit">$</span><span class="number"><?php echo count($invoices); ?></span></p>
	                            <p class="caption">Invoices</p>
	                        </div>
	                ...
	                <div class="row">
	                    <div class="col-sm-6">
	                        <article class="statistic-box red">
	                            <div>
	                                ...
	                                <div class="caption"><div>Pending Schedules</div></div>
	                                <div class="percent">
	                                    <div class="arrow up"></div>
	                                    <p><?php echo (count($pending)/(count($pending)+ count($paid)))*100; ?>%</p>
	                                </div>
	                            </div>
	                        </article>
	                    </div><!--.col-->
	                    <div class="col-sm-6">
	                        <article class="statistic-box purple">
	                            <div>
	                                <div class="number"><?php echo count($paid); ?></div>
	                                <div class="caption"><div>Paid Schedules</div></div>
	                                <div class="percent">
	                                    <div class="arrow down"></div>
	                                    <p><?php echo (count($paid)/(count($pending)+ count($paid)))*100; ?>%</p>
	                                </div>
	                            </div>
	                        </article>
	                    </div><!--.col-->
	                    <div class="col-sm-6">
	                        <article class="statistic-box yellow">
	                            <div>
	                                <div class="number"><?php echo count($customers); ?></div>
	                                <div class="caption"><div>Customers</div></div>
	                                <div class="percent">
	                                    <div class="arrow down"></div>
	                                    <p>5%</p>
	                                </div>
	                    ...
	                    <div class="col-sm-6">
	                        <article class="statistic-box green">
	                            <div>
	                                ...
	                                <div class="caption"><div>Products /Merchandise</div></div>
	                                <div class="percent">
	                                    <div class="arrow up"></div>
	                                    <p>84%</p>
	                                </div>
	                            ...
	                            <div class="user-card-row">
	                                <div class="tbl-row">
	                                    <div class="tbl-cell tbl-cell-photo">
	                                        <a href="#">
	                                            <<?= base_url(); ?>img src="<?= base_url(); ?>img/photo-64-1.jpg" alt="">
	                                        </a>
	                                    </div>
	                                    <div class="tbl-cell">
	                        ...
	                        <article class="comment-item">
	                            <div class="user-card-row">
	                                <div class="tbl-row">
	                                    <div class="tbl-cell tbl-cell-photo">
	                                        <a href="#">
	                                            <<?= base_url(); ?>img src="<?= base_url(); ?>img/photo-64-2.jpg" alt="">
	                                        </a>
	                                    </div>
	                                    <div class="tbl-cell">
	                            ...
	                            <article class="contact-row">
	                                <div class="user-card-row">
	                                    <div class="tbl-row">
	                                        <div class="tbl-cell tbl-cell-photo">
	                                            <a href="#">
	                                                <<?= base_url(); ?>img src="<?= base_url(); ?>img/photo-64-3.jpg" alt="">
	                                            </a>
	                                        </div>
	                                        <div class="tbl-cell">
	                            ...
	                            <article class="contact-row">
	                                <div class="user-card-row">
	                                    <div class="tbl-row">
	                                        <div class="tbl-cell tbl-cell-photo">
	                                            <a href="#">
	                                                <<?= base_url(); ?>img src="<?= base_url(); ?>img/photo-64-4.jpg" alt="">
	                                            </a>
	                                        </div>
	                                        <div class="tbl-cell">
	                                            <p class="user-card-row-name"><a href="#">Maggy Smith</a></p>
