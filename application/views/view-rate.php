                            ...
                            if (is_array($c) && count($c)) {
                                foreach ($c as $l) {
                                    ...
                                    <tr class="odd edit_tr" id="<?php echo $id; ?>">
                                        ...
                                        <td id="amount:<?php echo $l->Id; ?>" contenteditable="true">
                                            <?php echo $l->Amount; ?>
                                        </td>
                                        <td id="period:<?php echo $l->Id; ?>" contenteditable="true">
                                            <?php echo $l->Period; ?>
                                        </td>
                                        <td id="Units:<?php echo $l->Id; ?>" contenteditable="true">
                                            <?php echo $l->Units; ?>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <button onclick="window.location.href = '<?php echo base_url() . "index.php/rate/profile/" . $l->Id; ?>'" type="button" class="green tabledit-edit-button btn btn-sm btn-default" style="float: none;"><span class="glyphicon glyphicon-pencil"></span></button>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            $("td[contenteditable=true]").blur(function () {
                ...
                var value = $(this).text();
                $.post('<?php echo base_url() . "index.php/rate/update/"; ?>', field_id + "=" + value, function (data) {
                    if (data != '')
                    {
                        message_status.show();
