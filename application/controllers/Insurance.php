...
class Insurance extends CI_Controller {
    ...
    public function index() {
        ...
        $query = $this->Md->query("SELECT *,customer.name AS customer,customer.image AS customerImage FROM insurance LEFT JOIN customer ON insurance.customerID  = customer.Id");
        if ($query) {
            $data['c'] = $query;
        } else {
            $data['c'] = array();
        ...
        $this->load->view('view-insurance', $data);
    }
    ...
    public function delete() {
        ...
        $query = $this->Md->cascade($id, 'insurance', 'id');
        ...
        if (!empty($_POST)) {
            foreach ($_POST as $field_name => $val) {
                ...
                if (!empty($id) && !empty($field_name) && !empty($val)) {
                    ...
                    $this->Md->update_dynamic($id, 'id', 'insurance', $task);
                    echo "updated";
                } else {
